...
def load_inputs(
    ...
    result = {
        ...
        "theta": theta_list[theta_idxs[shot + 1]],
        "x_idx": x_idxs[shot],
        # <-- новые поля, которые нужны analyzer-у
        "x_space": task_dataframe[task_id]["x_space"],      # "color"
        "theta_space": task_dataframe[task_id]["theta_space"],  # "object"
        "target_x": x_list[x_idxs[shot]],                  # "orange"
    }
    return result
